  ...
  configs: {
    recommended: {
      ...
      overrides: [
        ...
        { files: ['*.d.ts'], parser: '@typescript-eslint/parser', rules: { 'no-unused-vars': 'off' } }, // <--- when declaring a function, of course its parameters are going to be "unused", so we need to turn this rule off.
      ],
      rules: {
        ...baseRules,
        ...importRules,
